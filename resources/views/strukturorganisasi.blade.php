    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <h4>Struktur<span>Organisasi</span></h4>
        </div>
          <div class="col-lg-8" data-aos="fade-right" data-aos-delay="100">
            <img src="assets/img/nuzulalogo.png" class="img-fluid" alt="">
          </div><br><br><br>
        <div class="row">
          <div class="col-lg-12 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <p align="justify">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corrupti, rerum. Aliquam delectus officiis, illum rerum assumenda necessitatibus voluptas quam consectetur accusantium adipisci fugit iste molestiae obcaecati incidunt eum veritatis doloribus!
            </p>
          </div>
          </div>
        </div>
